...
// setCache 设置缓存
func (m *Btoken) setCache(ctx context.Context, cacheKey string, userCache g.Map) Resp {
	switch m.CacheMode {
...
// getCache 获取缓存
func (m *Btoken) getCache(ctx context.Context, cacheKey string) Resp {
	var userCache g.Map
	switch m.CacheMode {
	case CacheModeCache, CacheModeFile:
...
// removeCache 删除缓存
func (m *Btoken) removeCache(ctx context.Context, cacheKey string) Resp {
	switch m.CacheMode {
	case CacheModeCache, CacheModeFile:
...
func (m *Btoken) writeFileCache(ctx context.Context) {
...
func (m *Btoken) initFileCache(ctx context.Context) {
	file := gfile.Temp(CacheModeFileDat)
